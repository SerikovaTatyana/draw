...
<body>
	...
	<header id="header">
				...
				<nav role="navigation" class="globalnav">
                    <ul>
						...
						@if(Auth::check())
							...
							<li><a href="{{ route('personal_area.index') }}">Личный кабинет</a></li>

						@else

							<li class="second"><a href="{{ route('register') }}">Регистрация</a></li>
							<li class="third"><a href="{{ route('login') }}">Вход</a></li>
		...
		<div class="head-cont">
			<div class="row">
				<a href="#" tabindex="0">Купить онлайн</a>
			</div>
		</div>
	-->
